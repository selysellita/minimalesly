...
const ProductDetail =(props)=>{
            ...
            .then((res1)=>{
                ...
                if(res1.data.length){
                    ...
                    .then((res2)=>{
                        ...
                        .then((res4)=>{
                            var tambah=false
                            res4.data[0].transactiondetails.map((val,index)=>{
                                if(val.productId===data.id){
                                    Axios.patch(`${API_URL}/transactiondetails/${val.id}`,{qty:val.qty+qty})
                                    tambah=true
                                }
    ...
    const {name,image,seen,stock,cost}=data
    if(redirectlog){
    ...
    if(data){
        return(
            <div className='paddingatas'>
                ...
                <div className="row paddingatas">
                    <div className="col-md-4 p-2">
                        <div className="product-detail">
                            <img src={image} alt={name} width='300px' height='220px' className='rounded'/>
                        </div>
                    </div>
...
export default connect(MapstatetoProps,{IconCart}) (ProductDetail);